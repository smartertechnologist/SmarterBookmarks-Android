...
- Balises : ajout de la prise en charge des couleurs pour les balises avec des couleurs de puce et des préférences de contour personnalisables
- Signets : ajout d'un champ de commentaire pour stocker des notes et des informations supplémentaires pour chaque signet
- Interface utilisateur : performances de rendu optimisées des signets et des balises, disposition améliorée des balises avec superpositions de sélection, présentations améliorées des vues de collection et chargement plus rapide des images.
...
- Récupération des métadonnées : Récupération des métadonnées : Extraction des métadonnées améliorée pour certains sites web.
...
- Correction des favoris n'affichant pas les dernières modifications lors de la synchronisation cloud
